...
def get_ai2thor_actionable_types() -> List[str]:
  ...
  """
  cur = globals.CONN.execute('SELECT DISTINCT name FROM ai2thor_action_types')
...
def get_material_property_types() -> List[str]:
  ...
  """
  cur = globals.CONN.execute('SELECT DISTINCT name FROM material_property_types')
...
def get_receptacle_types() -> List[str]:
  ...
  """
  cur = globals.CONN.execute('SELECT DISTINCT name FROM receptacle_types')
...
def get_scene_types() -> List[str]:
  ...
  """
  cur = globals.CONN.execute('SELECT DISTINCT name FROM scene_types')
...
def get_object_names() -> List[str]:
  ...
  Returns:
    ...
    attribute.
  """
  cur = globals.CONN.execute('SELECT DISTINCT name FROM objects')
